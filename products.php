...
<html class="no-js" lang="en">
	...
	<body>
		<div id="app">
			...
			<!-- start hero -->
			<div id="hero" class="jarallax" data-speed="0.7" data-img-position="50% 5%" style="background-image: url(img/intro_img/11.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-7">
							<h1 class="__title"><span>major</span> products</h1>
			...
			<main role="main">
					...
					<div class="container">
						<div class="row justify-content-xl-between">
							<div class="col-12 col-lg col-xl-7">
								<h2>Agro Farm <span>Ecology Products</span></h2>

								<p>
									<strong>Agro is a high-quality service, innovative technologies and a wide product range that meet the requirements of modern farmers. Speсtr-Agro is a united team of high-class professionals working for the growth and development of the agricultural business in USA.</strong>
								</p>
							...
							<div class="col-12 col-lg-auto  text-center">
								<img class="img-fluid  lazy" src="img/blank.gif" data-src="img/img_5.png" alt="demo" />
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container-fluid">
						...
						<div class="products-list">
							...
							<div class="__item">
								<div class="__bg">
									<div data-jarallax-element="-140" data-speed="0.4">
										<img class="img-fluid lazy" width="224" height="243" src="img/blank.gif" data-src="img/products_img/bg_1.png" alt="demo"/>
									</div>
								</div>
								...
								<div class="__inner">
									<div class="row align-items-lg-center justify-content-sm-center">
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__image">
												<img class="img-fluid lazy" src="img/blank.gif" data-src="img/products_img/1.jpg" alt="demo"/>
											</div>
										</div>
										...
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__content">
												...
												<p>
													<a class="custom-btn custom-btn--medium custom-btn--style-1" href="#">Read more</a>
												</p>
											</div>
										</div>
									</div>
							...
							<div class="__item">
								<div class="__bg">
									<div data-jarallax-element="-140" data-speed="0.4">
										<img class="img-fluid lazy" width="175" height="309" src="img/blank.gif" data-src="img/products_img/bg_2.png" alt="demo"/>
									</div>
								</div>
								...
								<div class="__inner">
									<div class="row align-items-lg-center justify-content-sm-center">
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__image">
												<img class="img-fluid lazy" src="img/blank.gif" data-src="img/products_img/2.jpg" alt="demo"/>
											</div>
										</div>
										...
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__content">
												<h3 class="__title">Fresh <span>Fruits</span></h3>
							...
							<div class="__item">
								<div class="__bg">
									<div data-jarallax-element="-140" data-speed="0.4">
										<img class="img-fluid lazy" width="196" height="289" src="img/blank.gif" data-src="img/products_img/bg_3.png" alt="demo"/>
									</div>
								</div>
								...
								<div class="__inner">
									<div class="row align-items-lg-center justify-content-sm-center">
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__image">
												<img class="img-fluid lazy" src="img/blank.gif" data-src="img/products_img/3.jpg" alt="demo"/>
											</div>
										</div>
										...
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__content">
												<h3 class="__title">Farm <span>Livestock</span></h3>
							...
							<div class="__item">
								<div class="__bg">
									<div data-jarallax-element="-140" data-speed="0.4">
										<img class="img-fluid lazy" width="199" height="381" src="img/blank.gif" data-src="img/products_img/bg_4.png" alt="demo"/>
									</div>
								</div>
								...
								<div class="__inner">
									<div class="row align-items-lg-center justify-content-sm-center">
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__image">
												<img class="img-fluid lazy" src="img/blank.gif" data-src="img/products_img/4.jpg" alt="demo"/>
											</div>
										</div>
										...
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__content">
												<h3 class="__title"> Fresh Vegatables</h3>

												<p>
													Evulates vast a real proven works discount secure care. Market invigorate a awesome handcrafted bigger comes newer recommended lifetime. Odor to yummy high racy bonus soaking mouthwatering.
												</p>

												<p>
													First superior full-bodied drink. Like outstanding odor economical deal clinically. Odor to yummy high racy bonus soaking
												</p>
							...
							<div class="__item">
								<div class="__bg">
									<div data-jarallax-element="-140" data-speed="0.4">
										<img class="img-fluid lazy" width="281" height="381" src="img/blank.gif" data-src="img/products_img/bg_5.png" alt="demo"/>
									</div>
								</div>
								...
								<div class="__inner">
									<div class="row align-items-lg-center justify-content-sm-center">
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__image">
												<img class="img-fluid lazy" src="img/blank.gif" data-src="img/products_img/5.jpg" alt="demo"/>
											</div>
										</div>
										...
										<div class="col-12 col-md-9 col-lg-6">
											<div class="__content">
												<h3 class="__title"> Agro <span>Machinery</span></h3>
				...
				<!-- start section -->
				<section class="section section--gutter section--gray-bg">
					<div class="container">
						<!-- start counters -->
						<div class="counter">
							<div class="__inner">
										...
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="150">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="img/blank.gif" data-src="img/ico/ico_count_1-2.png" alt="demo" />
													</i>
												</div>
									...
									<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="300">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="img/blank.gif" data-src="img/ico/ico_count_2-2.png" alt="demo" />
													</i>
												</div>
									...
									<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="450">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="img/blank.gif" data-src="img/ico/ico_count_3-2.png" alt="demo" />
													</i>
												</div>
									...
									<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
										<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="600">
											<div class="d-table">
												<div class="d-table-cell align-middle">
													<i class="__ico">
														<img class="img-fluid  lazy" src="img/blank.gif" data-src="img/ico/ico_count_4-2.png" alt="demo" />
													</i>
												</div>
				...
				<!-- start section -->
				<section class="section section--review  lazy" data-src="img/review_bg_2.png">
					<div class="container">
