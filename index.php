		...
		<div id="app">
									...
									jQuery(document).ready(function($){
										...
										var slider = $('#vegas-slider'),
											slides = [
												{
													name: "img 1",
													src: 'img/home_img/overlays/img_1.jpg'
												},
												{
													name: "img 2",
													src: 'img/home_img/overlays/img_2.jpg'
												},
												{
													name: "img 3",
													src: 'img/home_img/overlays/img_5.jpg'
												}
											],
						...
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-12 col-md-12 col-xl-12">
									...
									<h2 class="__title text-white">Clarkia Agro Commodities</h2>
									...
									<p class="text-center mt-5 mt-md-10">
										<span class="d-none d-sm-block"><a class="custom-btn custom-btn--big custom-btn--style-3" href="#special">Discover</a></span>

										<span class="d-block d-sm-none"><a class="custom-btn custom-btn--small custom-btn--style-3" href="#special">Discover</a></span>
									</p>
								</div>
							</div>
						</div>
			...
			<main role="main">
				...
				<section id="special" class="section">
					<div class="container">
						<div class="section-heading section-heading--center" data-aos="fade">
							<h2 class="__title">What <span>We Do</span></h2>
								...
								<div class="row">
									...
									<div class="col-6 col-sm-4 col-lg-2">
										<div class="__item  text-center" data-aos="fade" data-aos-delay="200" data-aos-offset="100">
											...
											<h5 class="__title">Edible Oil</h5>
										</div>
									</div>
									<!-- end item -->
				...
				<section class="section section--no-pt section--no-pb">
					<div class="container">
						<div class="special-offer special-offer--style-1" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="70">
							<h2 class="text text-center lazy"  data-src="img/special_offer_text_bg.jpg">Special products for most people</h2>
						</div>
					</div>
				</section>
				<!-- end section -->
						...
						<div class="row align-items-center">
							<div class="col-12 col-lg-4">
								<div data-aos="fade-left" data-aos-delay="400" data-aos-duration="500" ddata-aos-offset="100">
									<div class="section-heading">
										<h2 class="__title">About Clarkia  <span>Agro company</span></h2>
									</div>

									<p class="d-none d-sm-block">
										<a class="custom-btn custom-btn--medium custom-btn--style-1" href="about.php">More about</a>
									</p>
								</div>
							</div>
							...
							<div class="col-12 col-lg-4  text-center">
								<div data-aos="fade-up" ddata-aos-duration="600" data-aos-offset="100">
									<img class="img-fluid  lazy" src="img/blank.gif" data-src="img/img_1.png" alt="demo" />
								</div>
							</div>
							...
							<div class="col-12 col-lg-4">
								<div data-aos="fade-right" data-aos-delay="400" data-aos-duration="500" ddata-aos-offset="100">
									...
									<p>
										The company has been trading & merchandising Rice, edible Oil, Grains, Pulses, Spices, biscuits, potato chips and various agro based products in all the principal world markets and to the end users in major consumption markets. 
									</p>
				...
				<section class="section">
					<div class="container">
						<div class="section-heading section-heading--center" data-aos="fade">
							<h2 class="__title">Our presence <span>Countries</span></h2>

						</div>

						<div data-aos="slide-up" data-aos-duration="800" data-aos-offset="50">
							<img class="img-fluid  lazy" src="img/blank.gif" data-src="img/img_world_map.png" alt="demo" />
						</div>
					</div>
				</section>
				<!-- end section -->
							...
							<div class="__inner">
								<div class="row">
											...
											<div class="__intro-text">
												<div class="row">
													<div class="col-md-11">
														...
														<p>
															<a class="custom-btn custom-btn--medium custom-btn--style-1" href="rice.php">all products</a>
														</p>
													</div>
												</div>
											</div>
									...
									<div class="col-12 col-md-5 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="img/blank.gif" data-src="img/product-preview_img/1.jpg" alt="demo" />
											</figure>

											<div class="__content">
												<h3 class="__title">Rice</h3>
											</div>

											<a class="__link" href="rice.php"></a>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-md-4 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="img/blank.gif" data-src="img/product-preview_img/2.jpg" alt="demo" />
											</figure>

											<div class="__content">
												<h3 class="__title">Edible Oil</h3>
											</div>

											<a class="__link" href="edible-oil.php"></a>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-md-4 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="img/blank.gif" data-src="img/product-preview_img/3.jpg" alt="demo" />
											</figure>

											<div class="__content">
												<h3 class="__title">Buscuits</h3>
											</div>

											<a class="__link" href="processed-foods.php"></a>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-md-4 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="img/blank.gif" data-src="img/product-preview_img/4.jpg" alt="demo" />
											</figure>

											<div class="__content">
												<h3 class="__title">Coffee</h3>
											</div>

											<a class="__link" href="imports.php"></a>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-xl-6">
										<div class="__item">
											<div class="__content">
												<h2 class="__title"><b>16</b>Type of <br>products</h2>
											</div>
									...
									<div class="col-12 col-md-7 col-xl-6 offset-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="img/blank.gif" data-src="img/product-preview_img/5.jpg" alt="demo" />
											</figure>

											<div class="__content">
												<h3 class="__title">Sabudana</h3>
											</div>

											<a class="__link" href="domestic.php"></a>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-md-5 col-xl-3">
										<div class="__item">
											<figure class="__image">
												<img class="lazy" src="img/blank.gif" data-src="img/product-preview_img/6.jpg"  alt="demo" />
											</figure>

											<div class="__content">
												<h3 class="__title">Dry Coconut</h3>
											</div>
				...
				<section class="section section--review  lazy" data-src="img/review_bg_1.png">
					<div class="container">
						<div class="section-heading section-heading--center" data-aos="fade">
							<h2 class="__title">People says <span>about clarkia</span></h2>
							...
							<div class="js-slick" data-slick='{"autoplay": true, "arrows": false, "dots": true, "speed": 1000}'>
								...
								<div class="review__item">
									<div class="review__item__text">
										<p>
											<i>Clarkia is an amazing company. Always fulfilled our expectations when it comes to quality and consistent deliveries.</i>
										</p>
									</div>
									...
									<div class="review__item__author  d-table">
										...
										<div class="d-table-cell align-middle">
											<span class="review__item__author-name"><strong>Fozia Moussa</strong></span>
											<span class="review__item__author-position">/CEO, Zoom Africa FZCO Djibouti</span>
										</div>
									</div>
								</div>
								<!-- end item -->
								...
								<div class="review__item">
									<div class="review__item__text">
										<p>
											<i>The best rice and agro product exporting company with very good quality and best prices.</i>
										</p>
									...
									<div class="review__item__author  d-table">
										...
										<div class="d-table-cell align-middle">
											<span class="review__item__author-name"><strong>Abraham Oldjira</strong></span>
											<span class="review__item__author-position">/Director, Orbit International FZCO Djibouti</span>
										</div>
									</div>
								</div>
								<!-- end item -->
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<div class="__item __item--preview" data-aos="flip-up" data-aos-delay="100" data-aos-offset="0">
											...
											<div class="__content">
												...
												<h3 class="__title h5"><a href="blog">Tips for Ripening your Fruit</a></h3>

												<p>
													The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.
												</p>

												<a class="custom-btn custom-btn--medium custom-btn--style-1" href="blog">Read more</a>
											</div>
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<div class="__item __item--preview" data-aos="flip-up" data-aos-delay="200" data-aos-offset="0">
											...
											<div class="__content">
												...
												<h3 class="__title h5"><a href="blog">Health Benefits of a Raw Food</a></h3>
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<div class="__item __item--preview" data-aos="flip-up" data-aos-delay="300" data-aos-offset="0">
											...
											<div class="__content">
												...
												<h3 class="__title h5"><a href="blog">Superfoods you should be eating</a></h3>
			...
			<!-- start section -->
				<section class="section section--dark-bg">
					<div class="container">
						...
						<form class="contact-form js-contact-form"  id="contact-form" action="mail/send2.php" name="customerData" method="post" onSubmit="javascript: return enquiryvalid(this); data-aos="fade">
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="input-wrp">
										<input class="textfield" name="contact" type="number" pattern="^[0-9-+\s()]*$" minlength="10" maxlength="10" placeholder="Number" required="" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="input-wrp">
										<input class="textfield" name="email" type="email" placeholder="E-mail" required=""  />
									</div>
								</div>

								<div class="col-12 col-md-6">
									<div class="input-wrp">
										<input class="textfield" name="comment" type="text" placeholder="Comments" />
									</div>
								</div>
							</div>
