...
<html class="no-js" lang="en">
	...
	<body class="woocommerce-page cart-page">
		<div id="app">
			<!-- start header -->
								...
								<div class="d-lg-flex flex-lg-column-reverse align-items-lg-end">
									<nav id="top-bar__navigation" class="top-bar__navigation navigation" role="navigation">
										<ul>
											...
											<li class="li-profile">
												<a href="#"><i class="fontello-profile"></i></a>
											</li>

											<li class="li-cart">
												<a href="#"><i class="fontello-shopping-bag"></i><span class="total">0</span></a>
											</li>
				...
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-7">
							<h1 class="__title"><span>Agro Shop</span> Cart</h1>
